            ...
            <div class="contact-form">
                ...
                <form id="ServiceRequest" action="<?= current_url() ?>" method='post'>
                    ...
                    <div class="form-group">
                        <label class="control-label">ServiceType: (Please refer to the above package section for info.) </label>
                        <select name="Service_type" class="form-control" id="ServiceId">
                            <option value="0" selected>On-Demand Service</option>
                    ...
                    <div class="form-group">
                        ...
                        <!-- display map  !-->
                        <div id="map" class="well well-sm col-xs-12" style="height: 600px;"></div>
                        <!-- current latituide and longtuide  !-->
                        <input id="ProviderId" name="ProviderId" type="hidden" value="" />
                        <input id="lat" type="hidden" value="" />
                        <input id="lng" type="hidden" value="" />
                        <button type="button" class="btn btn-success" onclick="RelatedLocationAjax();">Show me guide</button>
                    </div>
                </form>
            </div>
        </div><!-- /.container -->
   ...
   <script>
    ...
    var mapOptions = {
        zoom: 12,
        center: {lat:26.9105166, lng:75.7726594}
    }; // map options
    ...
    // to draw circle around 10 kilometers to current location
